...
@section('title', 'auth vikativaet boy next door')
    ...
    <div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
        <div class="bg-white w-96 shadow-xl rounded p-5">
            ...
            <form method="POST" action="{{ route("login_process") }}" class="space-y-5 mt-5">
                ...
                <input name="password" type="password" class="w-full h-12 border border-gray-800 rounded px-3 @error('email') border-red-500 @enderror" placeholder="Пароль" />
